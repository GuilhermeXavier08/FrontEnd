import Equipamento, { IEquip } from "@/models/Equipamento"
...
export const createEquipamento = async(data: Partial<IEquip>)=>{
    await connectMongo()
...
export const updateEquipamento = async(id:string, data: Partial<IEquip>) =>{
    await connectMongo()
